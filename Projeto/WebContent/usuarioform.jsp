	...
	<section id="main-content">
		<section class="wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					<section class="panel">
						<header class="panel-heading"> Novo Usuário </header>
						<div class="panel-body">
							<div class="form">
								<form class="franquia" method="post" action="usuarios">
									<div class="form-group ">
										<label for="cname" class="control-label col-lg-2">Usuário<span class="required">*</span>
										</label>
										<div class="col-lg-10">
									...
									<div class="form-check">
										<label for="cname" class="control-label col-lg-2">Qual
											será a função do usuário?<span class="required">*</span>
										</label>
										<div class="col-lg-1">
