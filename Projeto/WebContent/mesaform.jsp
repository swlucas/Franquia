   ...
   <c:import url="topo.jsp"></c:import>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-files-o"></i> Mesas</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.jsp">Home</a></li>
              <li><i class="icon_document_alt"></i>Mesas</li>
          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="franquia" method="post" action="mesas">
                    ...
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Andar<span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control " type="text" name="andar" />
                      </div>
                    </div>
                    <div class="form-group ">
