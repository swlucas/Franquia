                  ...
                  <form class="franquia" method="post" action="franqueado">
                    <div class="form-group ">
                      ...
                      <input class="form-control"name="id"  type="hidden" value="${franqueado.id}" />
                        <input class="form-control"name="nome" value="${franqueado.nome}" type="text" />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">cpf<span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" value="${franqueado.cpf}" type="text" name="cpf" />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Telefone <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" value="${franqueado.telefone}" type="text" name="telefone" />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Email<span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" type="text" value="${franqueado.email}" name="email" />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Endereco<span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" type="text" value="${franqueado.endereco}" name="endereco" />
                      </div>
                    </div>
                    <div class="form-group">
