...
<!-- Bootstrap CSS -->
<link href="/Projeto/css/bootstrap.min.css" rel="stylesheet">
<!-- bootstrap theme -->
<link href="/Projeto/css/bootstrap-theme.css" rel="stylesheet">
<!--external css-->
<!-- font icon -->
<link href="/Projeto/css/elegant-icons-style.css" rel="stylesheet" />
<link href="/Projeto/css/font-awesome.min.css" rel="stylesheet" />
<!-- full calendar css-->
<link
	href="/Projeto/assets/fullcalendar/fullcalendar/bootstrap-fullcalendar.css"
	rel="stylesheet" />
<link href="/Projeto/assets/fullcalendar/fullcalendar/fullcalendar.css"
	rel="stylesheet" />
<!-- easy pie chart-->
<link
	href="/Projeto/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css"
	rel="stylesheet" type="text/css" media="screen" />
<!-- owl carousel -->
<link rel="stylesheet" href="/Projeto/css/owl.carousel.css"
	type="text/css">
<link href="/Projeto/css/jquery-jvectormap-1.2.2.css" rel="stylesheet">
<!-- Custom styles -->
<link rel="stylesheet" href="/Projeto/css/fullcalendar.css">
<link href="/Projeto/css/widgets.css" rel="stylesheet">
<link href="/Projeto/css/style.css" rel="stylesheet">
<link href="/Projeto/css/style-responsive.css" rel="stylesheet" />
<link href="/Projeto/css/xcharts.min.css" rel=" stylesheet">
<link href="/Projeto/css/jquery-ui-1.10.4.min.css" rel="stylesheet">
...
<body>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box brown-bg">
						...
						%>
						<div class="count"><%=mesasDAO.totalMesas()%></div>
	...
	<script src="/Projeto/js/jquery-ui-1.10.4.min.js"></script>
	<script src="/Projeto/js/jquery-1.8.3.min.js"></script>
	<script type="text/javascript"
		src="/Projeto/js/jquery-ui-1.9.2.custom.min.js"></script>
	<!-- bootstrap -->
	<script src="/Projeto/js/bootstrap.min.js"></script>
	<!-- nice scroll -->
	<script src="/Projeto/js/jquery.scrollTo.min.js"></script>
	<script src="/Projeto/js/jquery.nicescroll.js" type="text/javascript"></script>
	<!-- charts scripts -->
	<script src="/Projeto/assets/jquery-knob/js/jquery.knob.js"></script>
	<script src="/Projeto/js/jquery.sparkline.js" type="text/javascript"></script>
	<script
		src="/Projeto/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
	<script src="/Projeto/js/owl.carousel.js"></script>
	<!-- jQuery full calendar -->
	<
	<script src="/Projeto/js/fullcalendar.min.js"></script>
	<!-- Full Google Calendar - Calendar -->
	<script src="/Projeto/assets/fullcalendar/fullcalendar/fullcalendar.js"></script>
	<!--script for this page only-->
	<script src="/Projeto/js/calendar-custom.js"></script>
	<script src="/Projeto/js/jquery.rateit.min.js"></script>
	<!-- custom select -->
	<script src="/Projeto/js/jquery.customSelect.min.js"></script>
	<script src="/Projeto/assets/chart-master/Chart.js"></script>

	<!--custome script for all page-->
	<script src="/Projeto/js/scripts.js"></script>
	<!-- custom script for this page-->
	<script src="/Projeto/js/sparkline-chart.js"></script>
	<script src="/Projeto/js/easy-pie-chart.js"></script>
	<script src="/Projeto/js/jquery-jvectormap-1.2.2.min.js"></script>
	<script src="/Projeto/js/jquery-jvectormap-world-mill-en.js"></script>
	<script src="/Projeto/js/xcharts.min.js"></script>
	<script src="/Projeto/js/jquery.autosize.min.js"></script>
	<script src="/Projeto/js/jquery.placeholder.min.js"></script>
	<script src="/Projeto/js/gdp-data.js"></script>
	<script src="/Projeto/js/morris.min.js"></script>
	<script src="/Projeto/js/sparklines.js"></script>
	<script src="/Projeto/js/charts.js"></script>
	<script src="/Projeto/js/jquery.slimscroll.min.js"></script>
	<script>
		//knob
		$(function() {
			$(".knob").knob({
