...
public class Usuario {
	...
	public Usuario(String nome, String cpf, String telefone, String endereco, String email) {
	...
	/*
	public Usuario(String login, String senha, Integer funcao,Integer franqueado_id) {
		super();
		this.login = login;
		this.senha = senha;
		this.funcao = funcao;
